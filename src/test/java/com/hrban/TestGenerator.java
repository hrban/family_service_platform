...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("hrban")
                .setOutputDir("/Users/apple/my_practice/family_service_platform/src/main/java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/family_service_platform?serverTimezone=UTC")
                .setUsername("root").setPassword("YaoShuai110522");
        ...
        packageConfig.setParent("com.hrban").setMapper("mapper")
